...
/* ----------------------------------------------
    ...
    * ---------------------------*/ 
    ...
    // Show New Shipping Address
    $(".newAddress .checkbox-row input[type='checkbox']").on('change', function () {
        var $Checked = $(this).is(':checked');
        if ($Checked == true) {
            $("#differentAdd").slideDown();
            $(".defaultAddress").slideUp();
        }
        else {
            $("#differentAdd").slideUp();
            $(".defaultAddress").slideDown();
        }
    });
